const apiEntryPoint =
    "https://bookish-halibut-gwxg5gp4wg4fv4q7-8000.app.github.dev";
...
const runTest = async (code: string, langauge: string, questionId: string): Promise<Response | ErrorResponse> => {
    const data = {
        code: code,
        language: langauge,
...
const submitCodeAPI = async (code: string, langauge: string, questionId: string): Promise<Response | ErrorResponse> => {
    const data = {
        code: code,
        language: langauge,
        questionId: questionId,
...
export { runTest, submitCodeAPI, addQuestion, getAllQuestions, getQuestionById, updateQuestion, getQuestionBySlug 
    , addTestCases, modifyTestCase
};
